...
import { ClientOptions } from 'originalvoices';
...
export { ClientOptions } from 'originalvoices';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/originalvoices',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the originalvoices MCP server. You will use Code Mode to help the user perform
