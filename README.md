...
```sh
npm install git+ssh://git@github.com:stainless-sdks/originalvoices-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install originalvoices`
...
const response = await client.topic.generateInsights({ audience: 'REPLACE_ME', topic: 'REPLACE_ME' });
...
await client.topic.generateInsights({ audience: 'REPLACE_ME', topic: 'REPLACE_ME' }, {
  maxRetries: 5,
});
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/originalvoices-typescript/issues) with questions, bugs, or suggestions.
